...
export class DiscrictRepositoryImpl implements DiscrictRepository {
  constructor(
  ...
  async findAll(): Promise<District[]> {
    const discricts = await this.districtRepository.find();

    return discricts.map((d) => DistrictMapper.toDomain(d));
  }
  ...
  async importDistricts(): Promise<void> {
    ...
    try {
      ...
      for (const data of districtData) {
        ...
        district.bnName = data.bn_name;

        const districtEntity = DistrictMapper.toPersistence(district);
